...
const StudentView = (props) => {
  ...
  return (
    <div>
      ...
      {student.campusId ? <h3><Link className="studentinfo" to={`/campus/${student.campusId}`}>{student.campus.name}</Link></h3> : <h3 className="studentinfo">The student doesn't have a campus</h3>}

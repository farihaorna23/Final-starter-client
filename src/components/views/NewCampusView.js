...
const NewCampusView = (props) => {
    const { handleChange, handleSubmit, description, address, name, imageUrl,} = props;
        ...
        <div style={{ minHeight: "calc(100vh - 114px)"}} className={classes.root}>
            <div className={classes.formContainer}>
                ...
                <form style={{ textAlign: 'center' }} onSubmit={(e) => handleSubmit(e)}>
                    ...
                    <input value={name} type="text" name="name" onChange={(e) => handleChange(e)} />
                    <br />
                    <br />

                    <label style={{ color: '#11153e', fontWeight: 'bold' }}>Description: </label>
                    <input value={description} type="text" name="description" onChange={(e) => handleChange(e)} />
                    <br />
                    <br />
